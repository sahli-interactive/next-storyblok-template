      ...
      <div className="flex justify-between py-16 sm:py-10">
        <div className="w-full lg:w-1/2 xl:w-6/12 text-center lg:text-left py-4 sm:p-0">
          ...
          <div className="flex flex-col sm:block py-4">
            <a
              target="_blank"
              href="https://www.storyblok.com/tc/nextjs"
              className="no-underline inline-block font-medium shadow uppercase rounded hover:shadow-md sm:mr-4 py-3 px-6 text-base mb-4 primary"
              rel="noreferrer"
            >
